...
const AddParkingLocation = ({navigation}: any) => {
  ...
  const showPicker = () => {
    setShow(true);
    setMode((prevMode: any) => (prevMode === 'date' ? 'time' : 'date'));
  };
  const [selectedDay, setSelectedDay] = useState(null);
  const [selectedHour, setSelectedHour] = useState(null);
  const [selectedMinute, setSelectedMinute] = useState(null);

  const generateItems = (maxValue: any) => {
    let items = [];
          ...
          <View style={styles.dropdownContainer}>
            ...
            <View style={styles.dropdown}>
              <Dropdown
                ...
                value={selectedDay}
                onChange={(item: any) => setSelectedDay(item.value)}
            ...
            <View style={styles.dropdown}>
              <Dropdown
                ...
                itemTextStyle={{color: 'black'}}
                value={selectedHour}
                onChange={(item: any) => setSelectedHour(item.value)}
                style={styles.dropdownInput}
              />
            ...
            <View style={styles.dropdown}>
              <Dropdown
                ...
                onChange={(item: any) => setSelectedMinute(item.value)}
                style={styles.dropdownInput}
              />
